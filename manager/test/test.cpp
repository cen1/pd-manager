...
void secondsPrettyPrint(uint32_t seconds)
{
	...
	const uint32_t hours = (seconds / 60 / 60) % 24;
	const uint32_t minutes = (seconds / 60) % 60;
	const uint32_t secondz = seconds % 60;
...
TEST(TestCases, BanDurationTest)
{
	...
	cout << "Testing 100 < games < 1000" << endl
		 << "===================" << endl;
	...
	cout << "Testing 1000 < games < 2000" << endl
		 << "===================" << endl;
	...
	cout << "Testing 2000 < games < 3000" << endl
		 << "===================" << endl;
	...
	cout << "Testing 3000 < games < 4000" << endl
		 << "===================" << endl;
	...
	cout << "Testing 4000 < games < 5000" << endl
		 << "===================" << endl;

	const uint32_t duration5k0 = MASL_PROTOCOL::CalcAutoBanDuration(0, 4500);
	secondsPrettyPrint(duration5k0);

	const uint32_t duration5k2 = MASL_PROTOCOL::CalcAutoBanDuration(2, 4500);
	secondsPrettyPrint(duration5k2);

	const uint32_t duration5k4 = MASL_PROTOCOL::CalcAutoBanDuration(4, 4500);
	secondsPrettyPrint(duration5k4);

	const uint32_t duration5k6 = MASL_PROTOCOL::CalcAutoBanDuration(6, 4500);
	secondsPrettyPrint(duration5k6);

	const uint32_t duration5k8 = MASL_PROTOCOL::CalcAutoBanDuration(8, 4500);
	secondsPrettyPrint(duration5k8);

	const uint32_t duration5k10 = MASL_PROTOCOL::CalcAutoBanDuration(10, 4500);
	secondsPrettyPrint(duration5k10);

	cout << "Testing games > 5000" << endl
		 << "===================" << endl;

	const uint32_t duration5k0Plus = MASL_PROTOCOL::CalcAutoBanDuration(0, 1000000);
	secondsPrettyPrint(duration5k0Plus);
	ASSERT_EQ(duration5k0, duration5k0Plus);

	const uint32_t duration5k2Plus = MASL_PROTOCOL::CalcAutoBanDuration(2, 1000000);
	secondsPrettyPrint(duration5k2Plus);
	ASSERT_EQ(duration5k2, duration5k2Plus);

	const uint32_t duration5k4Plus = MASL_PROTOCOL::CalcAutoBanDuration(4, 1000000);
	secondsPrettyPrint(duration5k4Plus);
	ASSERT_EQ(duration5k4, duration5k4Plus);

	const uint32_t duration5k6Plus = MASL_PROTOCOL::CalcAutoBanDuration(6, 1000000);
	secondsPrettyPrint(duration5k6Plus);
	ASSERT_EQ(duration5k6, duration5k6Plus);

	const uint32_t duration5k8Plus = MASL_PROTOCOL::CalcAutoBanDuration(8, 1000000);
	secondsPrettyPrint(duration5k8Plus);
	ASSERT_EQ(duration5k8, duration5k8Plus);

	const uint32_t duration5k10Plus = MASL_PROTOCOL::CalcAutoBanDuration(10, 1000000);
