		...
		if (!Message.empty() && Message[0] == m_CommandTrigger) {
			...
			if (IsRootAdmin(User)) {
				...
				//
					...
					m_GHost->CreateGame(m_GHost->m_Map, GAME_PRIVATE, false, Payload, User, User, m_Server, MASL_PROTOCOL::DB_DIV1_DOTA_GAME, false, vector<string>());
				...
				//
					...
					m_GHost->CreateGame(m_GHost->m_DotALadderMapObs, GAME_PRIVATE, false, Payload, User, User, m_Server, MASL_PROTOCOL ::DB_DIV1_DOTA_GAME, true, vector<string>());
				...
				//
					...
					m_GHost->CreateGame(m_GHost->m_Map, GAME_PUBLIC, false, Payload, User, User, m_Server, MASL_PROTOCOL::DB_DIV1_DOTA_GAME, false, vector<string>());
