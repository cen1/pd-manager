...
string CLanguage :: CheckedPlayer( string victim, string ping, string from, string admin, string owner, string spoofed, string spoofedrealm, string reserved, string gproxy )
{
	...
	UTIL_Replace( Out, "$RESERVED$", reserved );
	UTIL_Replace( Out, "$GPROXY$", gproxy );
	return Out;
}
...
string CLanguage::MutedPlayerBanlist(string victim)
{
