...
{
	BYTEARRAY packet;
	//if( toPIDs.empty( )) CONSOLE_Print("[DEBUG] EMPTY TOPIDS");
	//if (message.empty( )) CONSOLE_Print("[DEBUG] EMPTY MESSAGE");
	//if (message.size( ) >= 255) CONSOLE_Print("[DEBUG] MSG TOO LONG");
